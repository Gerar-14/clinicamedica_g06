...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference("Municipio.count") do
      post municipios_url, params: { municipio: { departamento_id: @municipio.departamento_id, nombre_municipio: @municipio.nombre_municipio } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { departamento_id: @municipio.departamento_id, nombre_municipio: @municipio.nombre_municipio } }
