...
class LaboratoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laboratorio" do
    assert_difference("Laboratorio.count") do
      post laboratorios_url, params: { laboratorio: { municipio_id: @laboratorio.municipio_id, nombre_laboratorio: @laboratorio.nombre_laboratorio } }
    end
  ...
  test "should update laboratorio" do
    patch laboratorio_url(@laboratorio), params: { laboratorio: { municipio_id: @laboratorio.municipio_id, nombre_laboratorio: @laboratorio.nombre_laboratorio } }
