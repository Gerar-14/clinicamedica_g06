...
class ParametrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parametro" do
    assert_difference("Parametro.count") do
      post parametros_url, params: { parametro: { nombre_parametro: @parametro.nombre_parametro, parametro_id: @parametro.parametro_id, tipo_parametro: @parametro.tipo_parametro, unidad_medida_id: @parametro.unidad_medida_id } }
    end
  ...
  test "should update parametro" do
    patch parametro_url(@parametro), params: { parametro: { nombre_parametro: @parametro.nombre_parametro, parametro_id: @parametro.parametro_id, tipo_parametro: @parametro.tipo_parametro, unidad_medida_id: @parametro.unidad_medida_id } }
